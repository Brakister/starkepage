    ...
    <header className="header">
      ...
      <div className="container">
        <div className="navbar">
          <Link to="/" className="logo" aria-label={`${site.name} – Início`}>
            <img src="/images/logo.svg" alt={`Logo ${site.name}`} width="40" height="40" loading="eager" />
            <span>Stärke <em>Premium</em> Parts</span>
          </Link>
          <button
            type="button"
          ...
          <a className="header-cta" href={whatsappLink()}>
            <IconWhatsapp /> Solicite Orçamento
          </a>
        </div>
      </div>
    </header>
